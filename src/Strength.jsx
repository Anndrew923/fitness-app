  ...
  return (
    <div className="strength-container">
      ...
      <div className="exercise-section">
        ...
        <label htmlFor="benchPressWeight" className="block text-sm font-medium text-gray-700">重量 (kg)</label>
        <input 
          id="benchPressWeight" 
        ...
        />
        <label htmlFor="benchPressReps" className="block text-sm font-medium text-gray-700">次數 (12次以下較準確)</label>
        <input 
          id="benchPressReps" 
          name="benchPressReps" 
          type="number" 
      ...
      <div className="exercise-section">
        ...
        <label htmlFor="squatWeight" className="block text-sm font-medium text-gray-700">重量 (kg)</label>
        <input 
          id="squatWeight" 
          name="squatWeight" 
          type="number" 
          ...
          className="input-field" 
        />
        <label htmlFor="squatReps" className="block text-sm font-medium text-gray-700">次數 (12次以下較準確)</label>
        <input 
          id="squatReps" 
          name="squatReps" 
          type="number" 
      ...
      <div className="exercise-section">
        ...
        <label htmlFor="deadliftWeight" className="block text-sm font-medium text-gray-700">重量 (kg)</label>
        <input 
          id="deadliftWeight" 
          name="deadliftWeight" 
          type="number" 
          ...
          className="input-field" 
        />
        <label htmlFor="deadliftReps" className="block text-sm font-medium text-gray-700">次數 (12次以下較準確)</label>
        <input 
          id="deadliftReps" 
          name="deadliftReps" 
          type="number" 
      ...
      <div className="exercise-section">
        ...
        <label htmlFor="latPulldownWeight" className="block text-sm font-medium text-gray-700">重量 (kg)</label>
        <input 
          ...
          className="input-field" 
        />
        <label htmlFor="latPulldownReps" className="block text-sm font-medium text-gray-700">次數 (12次以下較準確)</label>
        <input 
          id="latPulldownReps" 
      ...
      <div className="exercise-section">
        ...
        <label htmlFor="shoulderPressWeight" className="block text-sm font-medium text-gray-700">重量 (kg)</label>
        <input 
          ...
          className="input-field" 
        />
        <label htmlFor="shoulderPressReps" className="block text-sm font-medium text-gray-700">次數 (12次以下較準確)</label>
        <input 
      ...
      <div className="radar-chart">
        <h2 className="text-lg font-semibold text-center mb-4">力量評測雷達圖</h2>
