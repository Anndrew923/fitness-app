...
const TrainingTools = () => {
  ...
  const tools = [
    {
      ...
      description: t('tools.oneRM.desc') || '根據訓練重量和次數，精準計算你的最大肌力',
      category: 'weight',
      status: 'coming-soon',
    },
    {
      ...
      description: t('tools.restTimer.desc') || '精準控制組間休息時間，提升訓練效率',
      category: 'weight',
      status: 'coming-soon',
    },
    {
      ...
      description: t('tools.volumeCalculator.desc') || '記錄訓練動作、重量、組數，自動計算總訓練量',
      category: 'weight',
      status: 'coming-soon',
    },
    {
      ...
      description: t('tools.exerciseLibrary.desc') || '完整動作資料庫，包含 S~D 級動作分級系統',
      category: 'weight',
      status: 'coming-soon',
    },
    {
      ...
      description: t('tools.paceCalculator.desc') || '根據距離和時間，計算精準配速',
      category: 'cardio',
      status: 'coming-soon',
    },
    {
      ...
      description: t('tools.hrZone.desc') || '計算個人化心率訓練區間，科學化訓練',
      category: 'cardio',
      status: 'coming-soon',
    },
  ];
  ...
  const categories = [
    { id: 'weight', name: t('tools.category.weight') || '重量訓練', icon: '🏋️' },
    { id: 'cardio', name: t('tools.category.cardio') || '有氧運動', icon: '🏃' },
  ];
