...
import MagitekButton from './Common/MagitekButton/MagitekButton';
  ...
  return (
    <div className="social-login-container">
      ...
      <div className="social-buttons">
        {/* 魔導化 Google 登入按鈕：使用 MagitekButton 組件 */}
        <MagitekButton
          type="button"
          onClick={handleGoogleLogin}
          disabled={loading || !isInitialized}
          fullWidth
          className="magitek-google-btn"
        >
          <svg 
            ...
            style={{ 
              ...
              filter: 'drop-shadow(0 0 5px var(--color-arcane-blue))'
            }}
          >
