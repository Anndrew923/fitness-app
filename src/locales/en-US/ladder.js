export default {
  ladder: {
    ...
    empty: {
      ...
      button: 'Be the Champion',
      buttonLogin: 'Login to Start',
      desc: {
        strength: 'No strongmen have challenged yet. Are you the strongest?',
        muscle: 'Looking for muscle monsters... Show us your size!',
        cardio: 'The track is empty. Run a lap and show them your back!',
        power: 'Explosive power leaderboard awaits! Show your jump!',
        bodyFat: 'Body fat leaderboard awaits! Show your discipline!',
        login: 'Consistency leaderboard awaits! Start your streak!',
        local: 'No challengers in your district yet. Be the first local hero!',
        default: 'No data available. Claim the first spot!',
      },
    },
    emptyWeekly: {
  ...
  ladderCard: {
    ...
    weeklyTrainingHours: 'Weekly Hours',
    trainingYears: 'Training Years',
    hours: 'hrs',
    years: 'yrs',
    noTrainingInfo: 'No training info provided',
    trainingInfoHint: 'Fill in your profile to inspire others!',
